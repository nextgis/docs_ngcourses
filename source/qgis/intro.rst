...
Открыть слой water-polygon.shp из выгрузок.

Например, мы можем выбрать водные объекты с площадью выше заданной, и удалить их.
...
Оцифровать здания и пешеходные дороги по аэрофотоснимку.
...
Рисуем озера и болота по топокарте
-----------------------------
